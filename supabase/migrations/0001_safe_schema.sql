...
where not exists (select 1 from public.departments where code = 'ENG');

insert into public.departments (name, code, description)
select 'Health', 'MHO', 'Municipal Health Office'
where not exists (select 1 from public.departments where code = 'MHO');

insert into public.departments (name, code, description)
select 'Social Welfare', 'MSWDO', 'Municipal Social Welfare and Development Office'
where not exists (select 1 from public.departments where code = 'MSWDO');
